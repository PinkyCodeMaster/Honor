...
import { insertTasksSchema, patchTasksSchema, selectTasksSchema } from "../../db/schema/tasks.js";
...
export const patch = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.NOT_FOUND]: jsonContent(notFoundSchema, "Task not found"),
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(patchTasksSchema)
